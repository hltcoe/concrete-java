...
public class MathUtil {
  ...
  /**
   * Given two numbers logx=log(x) and logy=log(y), return log(x+y). Conceptually, this is the same as returning log(e**(logx)+e**(logy)), but the actual
   * implementation avoids overflow errors that could result from direct computation.
   */
