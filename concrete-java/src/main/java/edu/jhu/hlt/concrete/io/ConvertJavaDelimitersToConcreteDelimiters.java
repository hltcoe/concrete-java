...
/**
 * ProtoBuffers provide a method for storing multiple protobufs in the same file. However, this method only works in Java. In contrast, the Concrete Delim
 * format is cross platform. This class converts the Java file format to the Concrete file format.
 * 
 * @author Mark Dredze
 * 
 */
