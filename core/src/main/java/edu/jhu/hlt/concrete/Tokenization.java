...
public class Tokenization implements org.apache.thrift.TBase<Tokenization, Tokenization._Fields>, java.io.Serializable, Cloneable, Comparable<Tokenization> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TokenizationStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TokenizationTupleSchemeFactory();
  ...
  private java.util.List<TokenTagging> tokenTaggingList; // optional
  private java.util.List<Parse> parseList; // optional
  private java.util.List<DependencyParse> dependencyParseList; // optional
  private java.util.List<SpanLink> spanLinkList; // optional
  ...
  public Tokenization(Tokenization other) {
    ...
    if (other.isSetTokenTaggingList()) {
      java.util.List<TokenTagging> __this__tokenTaggingList = new java.util.ArrayList<TokenTagging>(other.tokenTaggingList.size());
    ...
    if (other.isSetParseList()) {
      java.util.List<Parse> __this__parseList = new java.util.ArrayList<Parse>(other.parseList.size());
    ...
    if (other.isSetDependencyParseList()) {
      java.util.List<DependencyParse> __this__dependencyParseList = new java.util.ArrayList<DependencyParse>(other.dependencyParseList.size());
    ...
    if (other.isSetSpanLinkList()) {
      java.util.List<SpanLink> __this__spanLinkList = new java.util.ArrayList<SpanLink>(other.spanLinkList.size());
  ...
  public void addToTokenTaggingList(TokenTagging elem) {
    if (this.tokenTaggingList == null) {
      this.tokenTaggingList = new java.util.ArrayList<TokenTagging>();
    }
    this.tokenTaggingList.add(elem);
  }

  public java.util.List<TokenTagging> getTokenTaggingList() {
    return this.tokenTaggingList;
  }

  public Tokenization setTokenTaggingList(java.util.List<TokenTagging> tokenTaggingList) {
  ...
  public void addToParseList(Parse elem) {
    if (this.parseList == null) {
      this.parseList = new java.util.ArrayList<Parse>();
    }
    this.parseList.add(elem);
  }

  public java.util.List<Parse> getParseList() {
    return this.parseList;
  }

  public Tokenization setParseList(java.util.List<Parse> parseList) {
  ...
  public void addToDependencyParseList(DependencyParse elem) {
    if (this.dependencyParseList == null) {
      this.dependencyParseList = new java.util.ArrayList<DependencyParse>();
    }
    this.dependencyParseList.add(elem);
  }

  public java.util.List<DependencyParse> getDependencyParseList() {
    return this.dependencyParseList;
  }

  public Tokenization setDependencyParseList(java.util.List<DependencyParse> dependencyParseList) {
  ...
  public void addToSpanLinkList(SpanLink elem) {
    if (this.spanLinkList == null) {
      this.spanLinkList = new java.util.ArrayList<SpanLink>();
    }
    this.spanLinkList.add(elem);
  }

  public java.util.List<SpanLink> getSpanLinkList() {
    return this.spanLinkList;
  }

  public Tokenization setSpanLinkList(java.util.List<SpanLink> spanLinkList) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case TOKEN_TAGGING_LIST:
      if (value == null) {
        ...
        setTokenTaggingList((java.util.List<TokenTagging>)value);
      }
      break;
    ...
    case PARSE_LIST:
      if (value == null) {
        ...
        setParseList((java.util.List<Parse>)value);
      }
      break;
    ...
    case DEPENDENCY_PARSE_LIST:
      if (value == null) {
        ...
        setDependencyParseList((java.util.List<DependencyParse>)value);
      }
      break;
    ...
    case SPAN_LINK_LIST:
      if (value == null) {
        ...
        setSpanLinkList((java.util.List<SpanLink>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetLattice()) ? 131071 : 524287);
    if (isSetLattice())
      hashCode = hashCode * 8191 + lattice.hashCode();

    hashCode = hashCode * 8191 + ((isSetKind()) ? 131071 : 524287);
    if (isSetKind())
      hashCode = hashCode * 8191 + kind.getValue();

    hashCode = hashCode * 8191 + ((isSetTokenTaggingList()) ? 131071 : 524287);
    if (isSetTokenTaggingList())
      hashCode = hashCode * 8191 + tokenTaggingList.hashCode();

    hashCode = hashCode * 8191 + ((isSetParseList()) ? 131071 : 524287);
    if (isSetParseList())
      hashCode = hashCode * 8191 + parseList.hashCode();

    hashCode = hashCode * 8191 + ((isSetDependencyParseList()) ? 131071 : 524287);
    if (isSetDependencyParseList())
      hashCode = hashCode * 8191 + dependencyParseList.hashCode();

    hashCode = hashCode * 8191 + ((isSetSpanLinkList()) ? 131071 : 524287);
    if (isSetSpanLinkList())
      hashCode = hashCode * 8191 + spanLinkList.hashCode();
  ...
  public int compareTo(Tokenization other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLattice()).compareTo(other.isSetLattice());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLattice()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTokenTaggingList()).compareTo(other.isSetTokenTaggingList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTokenTaggingList()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetParseList()).compareTo(other.isSetParseList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParseList()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDependencyParseList()).compareTo(other.isSetDependencyParseList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDependencyParseList()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSpanLinkList()).compareTo(other.isSetSpanLinkList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSpanLinkList()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Tokenization(");
    boolean first = true;
  ...
  private static class TokenizationStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TokenizationStandardScheme getScheme() {
      return new TokenizationStandardScheme();
    }
  }

  private static class TokenizationStandardScheme extends org.apache.thrift.scheme.StandardScheme<Tokenization> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tokenTaggingList = new java.util.ArrayList<TokenTagging>(_list88.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.parseList = new java.util.ArrayList<Parse>(_list91.size);
                Parse _elem92;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dependencyParseList = new java.util.ArrayList<DependencyParse>(_list94.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spanLinkList = new java.util.ArrayList<SpanLink>(_list97.size);
                SpanLink _elem98;
  ...
  private static class TokenizationTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TokenizationTupleScheme getScheme() {
      return new TokenizationTupleScheme();
    }
  }

  private static class TokenizationTupleScheme extends org.apache.thrift.scheme.TupleScheme<Tokenization> {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.tokenTaggingList = new java.util.ArrayList<TokenTagging>(_list108.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.parseList = new java.util.ArrayList<Parse>(_list111.size);
          Parse _elem112;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.dependencyParseList = new java.util.ArrayList<DependencyParse>(_list114.size);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.spanLinkList = new java.util.ArrayList<SpanLink>(_list117.size);
          SpanLink _elem118;
