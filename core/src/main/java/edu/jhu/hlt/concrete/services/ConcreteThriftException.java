...
public class ConcreteThriftException extends TException implements org.apache.thrift.TBase<ConcreteThriftException, ConcreteThriftException._Fields>, java.io.Serializable, Cloneable, Comparable<ConcreteThriftException> {
  ...
  static {
    schemes.put(StandardScheme.class, new ConcreteThriftExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ConcreteThriftExceptionTupleSchemeFactory());
  }
  ...
  public ConcreteThriftException setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public ConcreteThriftException setSerEx(ByteBuffer serEx) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ConcreteThriftException(");
    boolean first = true;
  ...
  private static class ConcreteThriftExceptionStandardSchemeFactory implements SchemeFactory {
    public ConcreteThriftExceptionStandardScheme getScheme() {
      return new ConcreteThriftExceptionStandardScheme();
    }
  }

  private static class ConcreteThriftExceptionStandardScheme extends StandardScheme<ConcreteThriftException> {
  ...
  private static class ConcreteThriftExceptionTupleSchemeFactory implements SchemeFactory {
    public ConcreteThriftExceptionTupleScheme getScheme() {
      return new ConcreteThriftExceptionTupleScheme();
    }
  }

  private static class ConcreteThriftExceptionTupleScheme extends TupleScheme<ConcreteThriftException> {
