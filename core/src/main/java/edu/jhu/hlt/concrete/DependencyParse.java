...
public class DependencyParse implements org.apache.thrift.TBase<DependencyParse, DependencyParse._Fields>, java.io.Serializable, Cloneable, Comparable<DependencyParse> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DependencyParseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DependencyParseTupleSchemeFactory();

  private edu.jhu.hlt.concrete.UUID uuid; // required
  private edu.jhu.hlt.concrete.AnnotationMetadata metadata; // required
  private java.util.List<Dependency> dependencyList; // required
  ...
  public DependencyParse(
    ...
    java.util.List<Dependency> dependencyList)
  {
    this();
    this.uuid = uuid;
  ...
  public DependencyParse(DependencyParse other) {
    ...
    if (other.isSetDependencyList()) {
      java.util.List<Dependency> __this__dependencyList = new java.util.ArrayList<Dependency>(other.dependencyList.size());
  ...
  public void addToDependencyList(Dependency elem) {
    if (this.dependencyList == null) {
      this.dependencyList = new java.util.ArrayList<Dependency>();
    }
    this.dependencyList.add(elem);
  }

  public java.util.List<Dependency> getDependencyList() {
    return this.dependencyList;
  }

  public DependencyParse setDependencyList(java.util.List<Dependency> dependencyList) {
    this.dependencyList = dependencyList;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case DEPENDENCY_LIST:
      if (value == null) {
        ...
        setDependencyList((java.util.List<Dependency>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDependencyList()) ? 131071 : 524287);
    if (isSetDependencyList())
      hashCode = hashCode * 8191 + dependencyList.hashCode();

    hashCode = hashCode * 8191 + ((isSetStructureInformation()) ? 131071 : 524287);
    if (isSetStructureInformation())
      hashCode = hashCode * 8191 + structureInformation.hashCode();
  ...
  public int compareTo(DependencyParse other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDependencyList()).compareTo(other.isSetDependencyList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDependencyList()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStructureInformation()).compareTo(other.isSetStructureInformation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStructureInformation()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DependencyParse(");
    boolean first = true;
  ...
  private static class DependencyParseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DependencyParseStandardScheme getScheme() {
      return new DependencyParseStandardScheme();
    }
  }

  private static class DependencyParseStandardScheme extends org.apache.thrift.scheme.StandardScheme<DependencyParse> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dependencyList = new java.util.ArrayList<Dependency>(_list16.size);
                Dependency _elem17;
  ...
  private static class DependencyParseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DependencyParseTupleScheme getScheme() {
      return new DependencyParseTupleScheme();
    }
  }

  private static class DependencyParseTupleScheme extends org.apache.thrift.scheme.TupleScheme<DependencyParse> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, DependencyParse struct) throws org.apache.thrift.TException {
      ...
      struct.setMetadataIsSet(true);
      {
        ...
        struct.dependencyList = new java.util.ArrayList<Dependency>(_list21.size);
        Dependency _elem22;
