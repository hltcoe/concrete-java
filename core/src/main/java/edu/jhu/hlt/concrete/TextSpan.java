...
public class TextSpan implements org.apache.thrift.TBase<TextSpan, TextSpan._Fields>, java.io.Serializable, Cloneable, Comparable<TextSpan> {
  ...
  static {
    schemes.put(StandardScheme.class, new TextSpanStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TextSpanTupleSchemeFactory());
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TextSpan(");
    boolean first = true;
  ...
  private static class TextSpanStandardSchemeFactory implements SchemeFactory {
    public TextSpanStandardScheme getScheme() {
      return new TextSpanStandardScheme();
    }
  }

  private static class TextSpanStandardScheme extends StandardScheme<TextSpan> {
  ...
  private static class TextSpanTupleSchemeFactory implements SchemeFactory {
    public TextSpanTupleScheme getScheme() {
      return new TextSpanTupleScheme();
    }
  }

  private static class TextSpanTupleScheme extends TupleScheme<TextSpan> {
