...
public class Situation implements org.apache.thrift.TBase<Situation, Situation._Fields>, java.io.Serializable, Cloneable, Comparable<Situation> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SituationStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SituationTupleSchemeFactory();

  private edu.jhu.hlt.concrete.UUID uuid; // required
  private java.lang.String situationType; // required
  private java.lang.String situationKind; // optional
  private java.util.List<Argument> argumentList; // optional
  private java.util.List<edu.jhu.hlt.concrete.UUID> mentionIdList; // optional
  private java.util.List<Justification> justificationList; // optional
  ...
  public Situation(Situation other) {
    ...
    if (other.isSetArgumentList()) {
      java.util.List<Argument> __this__argumentList = new java.util.ArrayList<Argument>(other.argumentList.size());
    ...
    if (other.isSetJustificationList()) {
      java.util.List<Justification> __this__justificationList = new java.util.ArrayList<Justification>(other.justificationList.size());
   ...
   * or a coarse grain situation type.
   */
  public Situation setSituationType(java.lang.String situationType) {
    this.situationType = situationType;
    return this;
  }
   ...
   * in the future.
   */
  public Situation setSituationKind(java.lang.String situationKind) {
  ...
  public void addToArgumentList(Argument elem) {
    if (this.argumentList == null) {
      this.argumentList = new java.util.ArrayList<Argument>();
    }
   ...
   * unordered.
   */
  public Situation setArgumentList(java.util.List<Argument> argumentList) {
   ...
   * (type=SituationMention)
   */
  public Situation setMentionIdList(java.util.List<edu.jhu.hlt.concrete.UUID> mentionIdList) {
  ...
  public void addToJustificationList(Justification elem) {
    if (this.justificationList == null) {
      this.justificationList = new java.util.ArrayList<Justification>();
    }
   ...
   * direct mentions of the situation, or indirect evidence.
   */
  public java.util.List<Justification> getJustificationList() {
   ...
   * direct mentions of the situation, or indirect evidence.
   */
  public Situation setJustificationList(java.util.List<Justification> justificationList) {
   ...
   * sentiment.
   */
  public Situation setPolarity(java.lang.String polarity) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ARGUMENT_LIST:
      if (value == null) {
        ...
        setArgumentList((java.util.List<Argument>)value);
      }
      break;
    ...
    case JUSTIFICATION_LIST:
      if (value == null) {
        ...
        setJustificationList((java.util.List<Justification>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetJustificationList()) ? 131071 : 524287);
    if (isSetJustificationList())
      hashCode = hashCode * 8191 + justificationList.hashCode();

    hashCode = hashCode * 8191 + ((isSetTimeML()) ? 131071 : 524287);
    if (isSetTimeML())
      hashCode = hashCode * 8191 + timeML.hashCode();
  ...
  public int compareTo(Situation other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetJustificationList()).compareTo(other.isSetJustificationList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJustificationList()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTimeML()).compareTo(other.isSetTimeML());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimeML()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Situation(");
    boolean first = true;
  ...
  private static class SituationStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SituationStandardScheme getScheme() {
      return new SituationStandardScheme();
    }
  }

  private static class SituationStandardScheme extends org.apache.thrift.scheme.StandardScheme<Situation> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.argumentList = new java.util.ArrayList<Argument>(_list16.size);
                Argument _elem17;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mentionIdList = new java.util.ArrayList<edu.jhu.hlt.concrete.UUID>(_list19.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.justificationList = new java.util.ArrayList<Justification>(_list22.size);
  ...
  private static class SituationTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SituationTupleScheme getScheme() {
      return new SituationTupleScheme();
    }
  }

  private static class SituationTupleScheme extends org.apache.thrift.scheme.TupleScheme<Situation> {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.argumentList = new java.util.ArrayList<Argument>(_list31.size);
          Argument _elem32;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.mentionIdList = new java.util.ArrayList<edu.jhu.hlt.concrete.UUID>(_list34.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.justificationList = new java.util.ArrayList<Justification>(_list37.size);
