...
public class SearchQuery implements org.apache.thrift.TBase<SearchQuery, SearchQuery._Fields>, java.io.Serializable, Cloneable, Comparable<SearchQuery> {
  ...
  private List<String> terms; // optional
  private List<String> questions; // optional
  private String communicationId; // optional
  private edu.jhu.hlt.concrete.TokenRefSequence tokens; // optional
  private String rawQuery; // optional
  ...
  private static final _Fields optionals[] = {_Fields.TERMS,_Fields.QUESTIONS,_Fields.COMMUNICATION_ID,_Fields.TOKENS,_Fields.RAW_QUERY,_Fields.AUTHS,_Fields.USER_ID,_Fields.NAME,_Fields.LABELS,_Fields.LANG,_Fields.CORPUS,_Fields.K};
  ...
  public SearchQuery(SearchQuery other) {
    ...
    if (other.isSetQuestions()) {
      List<String> __this__questions = new ArrayList<String>(other.questions);
   ...
   * implementation.
   */
  public SearchQuery setTerms(List<String> terms) {
    this.terms = terms;
    return this;
  }
  ...
  public java.util.Iterator<String> getQuestionsIterator() {
    return (this.questions == null) ? null : this.questions.iterator();
  }

  public void addToQuestions(String elem) {
   ...
   * capital?"
   */
  public SearchQuery setQuestions(List<String> questions) {
   ...
   * Refers to an optional communication that can provide context for the query.
   */
  public SearchQuery setCommunicationId(String communicationId) {
   ...
   * The input from the user provided in the search box, unmodified
   */
  public SearchQuery setRawQuery(String rawQuery) {
   ...
   * optional authorization mechanism
   */
  public SearchQuery setAuths(String auths) {
    this.auths = auths;
    return this;
  }
   ...
   * as a label ("spain"). User labels could be based on organizational units ("hltcoe").
   */
  public SearchQuery setLabels(List<String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   * An identifier of the corpus that the search is to be performed over.
   */
  public SearchQuery setCorpus(String corpus) {
    this.corpus = corpus;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case QUESTIONS:
      if (value == null) {
        ...
        setQuestions((List<String>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.questions = new ArrayList<String>(_list3.size);
                String _elem4;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.labels = new ArrayList<String>(_list6.size);
                String _elem7;
      ...
      if (struct.terms != null) {
        if (struct.isSetTerms()) {
          oprot.writeFieldBegin(TERMS_FIELD_DESC);
          {
            ...
            for (String _iter9 : struct.terms)
            {
      ...
      if (struct.questions != null) {
        if (struct.isSetQuestions()) {
          oprot.writeFieldBegin(QUESTIONS_FIELD_DESC);
          {
            ...
            for (String _iter10 : struct.questions)
            {
      ...
      if (struct.isSetTerms()) {
        {
          ...
          for (String _iter12 : struct.terms)
          {
      ...
      if (struct.isSetQuestions()) {
        {
          ...
          for (String _iter13 : struct.questions)
          {
      ...
      if (struct.isSetLabels()) {
        {
          ...
          for (String _iter14 : struct.labels)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.terms = new ArrayList<String>(_list15.size);
          String _elem16;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.questions = new ArrayList<String>(_list18.size);
          String _elem19;
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.labels = new ArrayList<String>(_list21.size);
          String _elem22;
