...
public class EmailCommunicationInfo implements org.apache.thrift.TBase<EmailCommunicationInfo, EmailCommunicationInfo._Fields>, java.io.Serializable, Cloneable, Comparable<EmailCommunicationInfo> {
  ...
  static {
    schemes.put(StandardScheme.class, new EmailCommunicationInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new EmailCommunicationInfoTupleSchemeFactory());
  }

  private String messageId; // optional
  private String contentType; // optional
  private String userAgent; // optional
  private List<String> inReplyToList; // optional
  private List<String> referenceList; // optional
  private EmailAddress senderAddress; // optional
  private EmailAddress returnPathAddress; // optional
  private List<EmailAddress> toAddressList; // optional
  private List<EmailAddress> ccAddressList; // optional
  private List<EmailAddress> bccAddressList; // optional
  private String emailFolder; // optional
  private String subject; // optional
  private List<String> quotedAddresses; // optional
  private List<String> attachmentPaths; // optional
  ...
  public EmailCommunicationInfo(EmailCommunicationInfo other) {
    ...
    if (other.isSetInReplyToList()) {
      List<String> __this__inReplyToList = new ArrayList<String>(other.inReplyToList);
      this.inReplyToList = __this__inReplyToList;
    }
    if (other.isSetReferenceList()) {
      List<String> __this__referenceList = new ArrayList<String>(other.referenceList);
    ...
    if (other.isSetToAddressList()) {
      List<EmailAddress> __this__toAddressList = new ArrayList<EmailAddress>(other.toAddressList.size());
    ...
    if (other.isSetCcAddressList()) {
      List<EmailAddress> __this__ccAddressList = new ArrayList<EmailAddress>(other.ccAddressList.size());
    ...
    if (other.isSetBccAddressList()) {
      List<EmailAddress> __this__bccAddressList = new ArrayList<EmailAddress>(other.bccAddressList.size());
    ...
    if (other.isSetQuotedAddresses()) {
      List<String> __this__quotedAddresses = new ArrayList<String>(other.quotedAddresses);
      this.quotedAddresses = __this__quotedAddresses;
    }
    if (other.isSetAttachmentPaths()) {
      List<String> __this__attachmentPaths = new ArrayList<String>(other.attachmentPaths);
  ...
  public EmailCommunicationInfo setMessageId(String messageId) {
  ...
  public EmailCommunicationInfo setContentType(String contentType) {
  ...
  public EmailCommunicationInfo setUserAgent(String userAgent) {
  ...
  public java.util.Iterator<String> getInReplyToListIterator() {
    return (this.inReplyToList == null) ? null : this.inReplyToList.iterator();
  }

  public void addToInReplyToList(String elem) {
    if (this.inReplyToList == null) {
      this.inReplyToList = new ArrayList<String>();
    }
  ...
  public EmailCommunicationInfo setInReplyToList(List<String> inReplyToList) {
  ...
  public java.util.Iterator<String> getReferenceListIterator() {
    return (this.referenceList == null) ? null : this.referenceList.iterator();
  }

  public void addToReferenceList(String elem) {
  ...
  public EmailCommunicationInfo setReferenceList(List<String> referenceList) {
  ...
  public EmailCommunicationInfo setToAddressList(List<EmailAddress> toAddressList) {
  ...
  public EmailCommunicationInfo setCcAddressList(List<EmailAddress> ccAddressList) {
  ...
  public EmailCommunicationInfo setBccAddressList(List<EmailAddress> bccAddressList) {
  ...
  public EmailCommunicationInfo setEmailFolder(String emailFolder) {
  ...
  public EmailCommunicationInfo setSubject(String subject) {
  ...
  public java.util.Iterator<String> getQuotedAddressesIterator() {
    return (this.quotedAddresses == null) ? null : this.quotedAddresses.iterator();
  }

  public void addToQuotedAddresses(String elem) {
    if (this.quotedAddresses == null) {
      this.quotedAddresses = new ArrayList<String>();
    }
  ...
  public EmailCommunicationInfo setQuotedAddresses(List<String> quotedAddresses) {
  ...
  public java.util.Iterator<String> getAttachmentPathsIterator() {
    return (this.attachmentPaths == null) ? null : this.attachmentPaths.iterator();
  }

  public void addToAttachmentPaths(String elem) {
  ...
  public EmailCommunicationInfo setAttachmentPaths(List<String> attachmentPaths) {
  ...
  public EmailCommunicationInfo setSalutation(String salutation) {
  ...
  public EmailCommunicationInfo setSignature(String signature) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case IN_REPLY_TO_LIST:
      if (value == null) {
        ...
        setInReplyToList((List<String>)value);
      }
      break;
    ...
    case REFERENCE_LIST:
      if (value == null) {
        ...
        setReferenceList((List<String>)value);
      }
      break;
    ...
    case TO_ADDRESS_LIST:
      if (value == null) {
        ...
        setToAddressList((List<EmailAddress>)value);
      }
      break;
    ...
    case CC_ADDRESS_LIST:
      if (value == null) {
        ...
        setCcAddressList((List<EmailAddress>)value);
      }
      break;
    ...
    case BCC_ADDRESS_LIST:
      if (value == null) {
        ...
        setBccAddressList((List<EmailAddress>)value);
      }
      break;
    ...
    case QUOTED_ADDRESSES:
      if (value == null) {
        ...
        setQuotedAddresses((List<String>)value);
      }
      break;
    ...
    case ATTACHMENT_PATHS:
      if (value == null) {
        ...
        setAttachmentPaths((List<String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_inReplyToList = true && (isSetInReplyToList());
    list.add(present_inReplyToList);
    if (present_inReplyToList)
      list.add(inReplyToList);

    boolean present_referenceList = true && (isSetReferenceList());
    list.add(present_referenceList);
    if (present_referenceList)
      list.add(referenceList);

    boolean present_senderAddress = true && (isSetSenderAddress());
    list.add(present_senderAddress);
    if (present_senderAddress)
      list.add(senderAddress);

    boolean present_returnPathAddress = true && (isSetReturnPathAddress());
    list.add(present_returnPathAddress);
    if (present_returnPathAddress)
      list.add(returnPathAddress);

    boolean present_toAddressList = true && (isSetToAddressList());
    list.add(present_toAddressList);
    if (present_toAddressList)
      list.add(toAddressList);

    boolean present_ccAddressList = true && (isSetCcAddressList());
    list.add(present_ccAddressList);
    if (present_ccAddressList)
      list.add(ccAddressList);

    boolean present_bccAddressList = true && (isSetBccAddressList());
    list.add(present_bccAddressList);
    if (present_bccAddressList)
      list.add(bccAddressList);

    boolean present_emailFolder = true && (isSetEmailFolder());
    list.add(present_emailFolder);
    if (present_emailFolder)
    ...
    boolean present_quotedAddresses = true && (isSetQuotedAddresses());
    list.add(present_quotedAddresses);
    if (present_quotedAddresses)
      list.add(quotedAddresses);

    boolean present_attachmentPaths = true && (isSetAttachmentPaths());
    list.add(present_attachmentPaths);
    if (present_attachmentPaths)
      list.add(attachmentPaths);

    boolean present_salutation = true && (isSetSalutation());
    list.add(present_salutation);
  ...
  public int compareTo(EmailCommunicationInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetInReplyToList()).compareTo(other.isSetInReplyToList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetReferenceList()).compareTo(other.isSetReferenceList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSenderAddress()).compareTo(other.isSetSenderAddress());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetReturnPathAddress()).compareTo(other.isSetReturnPathAddress());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetToAddressList()).compareTo(other.isSetToAddressList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetCcAddressList()).compareTo(other.isSetCcAddressList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetBccAddressList()).compareTo(other.isSetBccAddressList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetEmailFolder()).compareTo(other.isSetEmailFolder());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEmailFolder()) {
    ...
    lastComparison = Boolean.valueOf(isSetQuotedAddresses()).compareTo(other.isSetQuotedAddresses());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetAttachmentPaths()).compareTo(other.isSetAttachmentPaths());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class EmailCommunicationInfoStandardScheme extends StandardScheme<EmailCommunicationInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inReplyToList = new ArrayList<String>(_list0.size);
                String _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.referenceList = new ArrayList<String>(_list3.size);
                String _elem4;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.toAddressList = new ArrayList<EmailAddress>(_list6.size);
                EmailAddress _elem7;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ccAddressList = new ArrayList<EmailAddress>(_list9.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bccAddressList = new ArrayList<EmailAddress>(_list12.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.quotedAddresses = new ArrayList<String>(_list15.size);
                String _elem16;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attachmentPaths = new ArrayList<String>(_list18.size);
                String _elem19;
      ...
      if (struct.inReplyToList != null) {
        if (struct.isSetInReplyToList()) {
          oprot.writeFieldBegin(IN_REPLY_TO_LIST_FIELD_DESC);
          {
            ...
            for (String _iter21 : struct.inReplyToList)
            {
      ...
      if (struct.referenceList != null) {
        if (struct.isSetReferenceList()) {
          oprot.writeFieldBegin(REFERENCE_LIST_FIELD_DESC);
          {
            ...
            for (String _iter22 : struct.referenceList)
            {
      ...
      if (struct.quotedAddresses != null) {
        if (struct.isSetQuotedAddresses()) {
          oprot.writeFieldBegin(QUOTED_ADDRESSES_FIELD_DESC);
          {
            ...
            for (String _iter26 : struct.quotedAddresses)
            {
      ...
      if (struct.attachmentPaths != null) {
        if (struct.isSetAttachmentPaths()) {
          oprot.writeFieldBegin(ATTACHMENT_PATHS_FIELD_DESC);
          {
            ...
            for (String _iter27 : struct.attachmentPaths)
            {
  ...
  private static class EmailCommunicationInfoTupleScheme extends TupleScheme<EmailCommunicationInfo> {
      ...
      if (struct.isSetInReplyToList()) {
        {
          ...
          for (String _iter28 : struct.inReplyToList)
          {
      ...
      if (struct.isSetReferenceList()) {
        {
          ...
          for (String _iter29 : struct.referenceList)
          {
      ...
      if (struct.isSetQuotedAddresses()) {
        {
          ...
          for (String _iter33 : struct.quotedAddresses)
          {
      ...
      if (struct.isSetAttachmentPaths()) {
        {
          ...
          for (String _iter34 : struct.attachmentPaths)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.inReplyToList = new ArrayList<String>(_list35.size);
          String _elem36;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.referenceList = new ArrayList<String>(_list38.size);
          String _elem39;
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.toAddressList = new ArrayList<EmailAddress>(_list41.size);
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.ccAddressList = new ArrayList<EmailAddress>(_list44.size);
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.bccAddressList = new ArrayList<EmailAddress>(_list47.size);
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.quotedAddresses = new ArrayList<String>(_list50.size);
          String _elem51;
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.attachmentPaths = new ArrayList<String>(_list53.size);
          String _elem54;
