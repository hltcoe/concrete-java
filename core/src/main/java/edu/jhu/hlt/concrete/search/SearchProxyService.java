...
public class SearchProxyService {
  ...
  public interface Iface extends edu.jhu.hlt.concrete.services.Service.Iface {
     ...
     * @param provider
     */
    public SearchResult search(SearchQuery query, String provider) throws edu.jhu.hlt.concrete.services.ServicesException, org.apache.thrift.TException;

    /**
     * Get a list of search providers behind the proxy
     */
    public List<String> getProviders() throws edu.jhu.hlt.concrete.services.ServicesException, org.apache.thrift.TException;
     ...
     * @param provider
     */
    public List<SearchCapability> getCapabilities(String provider) throws edu.jhu.hlt.concrete.services.ServicesException, org.apache.thrift.TException;
     ...
     * @param provider
     */
    public List<String> getCorpora(String provider) throws edu.jhu.hlt.concrete.services.ServicesException, org.apache.thrift.TException;

  }

  public interface AsyncIface extends edu.jhu.hlt.concrete.services.Service .AsyncIface {

    public void search(SearchQuery query, String provider, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void getProviders(org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void getCapabilities(String provider, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void getCorpora(String provider, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends edu.jhu.hlt.concrete.services.Service.Client implements Iface {
    ...
    public void send_search(SearchQuery query, String provider) throws org.apache.thrift.TException
    {
    ...
    public List<String> recv_getProviders() throws edu.jhu.hlt.concrete.services.ServicesException, org.apache.thrift.TException
    {
    ...
    public void send_getCapabilities(String provider) throws org.apache.thrift.TException
    {
    ...
    public void send_getCorpora(String provider) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends edu.jhu.hlt.concrete.services.Service.AsyncClient implements AsyncIface {
    ...
    public static class search_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public search_call(SearchQuery query, String provider, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class getProviders_call extends org.apache.thrift.async.TAsyncMethodCall {
      public getProviders_call(org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
    ...
    public static class getCapabilities_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String provider;
      public getCapabilities_call(String provider, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.provider = provider;
      }
    ...
    public static class getCorpora_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String provider;
      public getCorpora_call(String provider, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.provider = provider;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends edu.jhu.hlt.concrete.services.Service.AsyncProcessor<I> {
    ...
    public static class getProviders<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getProviders_args, List<String>> {
      public getProviders() {
        super("getProviders");
      }
      ...
      public void start(I iface, getProviders_args args, org.apache.thrift.async.AsyncMethodCallback<List<String>> resultHandler) throws TException {
  ...
  public static class search_args implements org.apache.thrift.TBase<search_args, search_args._Fields>, java.io.Serializable, Cloneable, Comparable<search_args>   {
    ...
    public search_args setProvider(String provider) {
      this.provider = provider;
      return this;
    }
  ...
  public static class getProviders_args implements org.apache.thrift.TBase<getProviders_args, getProviders_args._Fields>, java.io.Serializable, Cloneable, Comparable<getProviders_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getProviders_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getProviders_argsTupleSchemeFactory());
    }
...
;
    ...
    private static class getProviders_argsStandardSchemeFactory implements SchemeFactory {
      public getProviders_argsStandardScheme getScheme() {
        return new getProviders_argsStandardScheme();
      }
    }

    private static class getProviders_argsStandardScheme extends StandardScheme<getProviders_args> {
    ...
    private static class getProviders_argsTupleSchemeFactory implements SchemeFactory {
      public getProviders_argsTupleScheme getScheme() {
        return new getProviders_argsTupleScheme();
      }
    }

    private static class getProviders_argsTupleScheme extends TupleScheme<getProviders_args> {
  ...
  public static class getProviders_result implements org.apache.thrift.TBase<getProviders_result, getProviders_result._Fields>, java.io.Serializable, Cloneable, Comparable<getProviders_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getProviders_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getProviders_resultTupleSchemeFactory());
    }
    ...
    public getProviders_result setSuccess(List<String> success) {
      this.success = success;
      return this;
    }
    ...
    private static class getProviders_resultStandardSchemeFactory implements SchemeFactory {
      public getProviders_resultStandardScheme getScheme() {
        return new getProviders_resultStandardScheme();
      }
    }

    private static class getProviders_resultStandardScheme extends StandardScheme<getProviders_result> {
    ...
    private static class getProviders_resultTupleSchemeFactory implements SchemeFactory {
      public getProviders_resultTupleScheme getScheme() {
        return new getProviders_resultTupleScheme();
      }
    }

    private static class getProviders_resultTupleScheme extends TupleScheme<getProviders_result> {
  ...
  public static class getCapabilities_args implements org.apache.thrift.TBase<getCapabilities_args, getCapabilities_args._Fields>, java.io.Serializable, Cloneable, Comparable<getCapabilities_args>   {
    ...
    public getCapabilities_args setProvider(String provider) {
      this.provider = provider;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<SearchCapability>(_list56.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<SearchCapability>(_list61.size);
  ...
  public static class getCorpora_args implements org.apache.thrift.TBase<getCorpora_args, getCorpora_args._Fields>, java.io.Serializable, Cloneable, Comparable<getCorpora_args>   {
    ...
    public getCorpora_args setProvider(String provider) {
      this.provider = provider;
      return this;
    }
