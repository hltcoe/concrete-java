...
public class ActiveLearnerServerService {
  ...
  public interface Iface extends edu.jhu.hlt.concrete.services.Service.Iface {
     ...
     * @param annotations
     */
    public void addAnnotations(edu.jhu.hlt.concrete.UUID sessionId, List<Annotation> annotations) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends edu.jhu.hlt.concrete.services.Service .AsyncIface {

    public void start(edu.jhu.hlt.concrete.UUID sessionId, AnnotationTask task, edu.jhu.hlt.concrete.services.AsyncContactInfo contact, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void stop(edu.jhu.hlt.concrete.UUID sessionId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void addAnnotations(edu.jhu.hlt.concrete.UUID sessionId, List<Annotation> annotations, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends edu.jhu.hlt.concrete.services.Service.Client implements Iface {
    ...
    public void send_addAnnotations(edu.jhu.hlt.concrete.UUID sessionId, List<Annotation> annotations) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends edu.jhu.hlt.concrete.services.Service.AsyncClient implements AsyncIface {
    ...
    public static class start_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public start_call(edu.jhu.hlt.concrete.UUID sessionId, AnnotationTask task, edu.jhu.hlt.concrete.services.AsyncContactInfo contact, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class addAnnotations_call extends org.apache.thrift.async.TAsyncMethodCall {
      private edu.jhu.hlt.concrete.UUID sessionId;
      private List<Annotation> annotations;
      public addAnnotations_call(edu.jhu.hlt.concrete.UUID sessionId, List<Annotation> annotations, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.sessionId = sessionId;
      ...
      public void getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_addAnnotations();
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends edu.jhu.hlt.concrete.services.Service.AsyncProcessor<I> {
    ...
    public static class start<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, start_args, Boolean> {
      public start() {
        super("start");
      }
      ...
      public void start(I iface, start_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
    ...
    public static class addAnnotations<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addAnnotations_args, Void> {
      ...
      public void start(I iface, addAnnotations_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
...
;
  ...
  public static class addAnnotations_args implements org.apache.thrift.TBase<addAnnotations_args, addAnnotations_args._Fields>, java.io.Serializable, Cloneable, Comparable<addAnnotations_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new addAnnotations_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new addAnnotations_argsTupleSchemeFactory());
    }
    ...
    public addAnnotations_args setAnnotations(List<Annotation> annotations) {
      this.annotations = annotations;
      return this;
    }
    ...
    private static class addAnnotations_argsStandardScheme extends StandardScheme<addAnnotations_args> {
    ...
    private static class addAnnotations_argsTupleScheme extends TupleScheme<addAnnotations_args> {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.annotations = new ArrayList<Annotation>(_list13.size);
            Annotation _elem14;
  ...
  public static class addAnnotations_result implements org.apache.thrift.TBase<addAnnotations_result, addAnnotations_result._Fields>, java.io.Serializable, Cloneable, Comparable<addAnnotations_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new addAnnotations_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new addAnnotations_resultTupleSchemeFactory());
    }
...
;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("addAnnotations_result(");
      boolean first = true;
    ...
    private static class addAnnotations_resultStandardScheme extends StandardScheme<addAnnotations_result> {
    ...
    private static class addAnnotations_resultTupleScheme extends TupleScheme<addAnnotations_result> {
