...
public class TwitterEntities implements org.apache.thrift.TBase<TwitterEntities, TwitterEntities._Fields>, java.io.Serializable, Cloneable, Comparable<TwitterEntities> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TwitterEntitiesStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TwitterEntitiesTupleSchemeFactory();

  private java.util.List<HashTag> hashtagList; // optional
  private java.util.List<URL> urlList; // optional
  private java.util.List<UserMention> userMentionList; // optional
  ...
  public TwitterEntities(TwitterEntities other) {
    if (other.isSetHashtagList()) {
      java.util.List<HashTag> __this__hashtagList = new java.util.ArrayList<HashTag>(other.hashtagList.size());
    ...
    if (other.isSetUrlList()) {
      java.util.List<URL> __this__urlList = new java.util.ArrayList<URL>(other.urlList.size());
    ...
    if (other.isSetUserMentionList()) {
      java.util.List<UserMention> __this__userMentionList = new java.util.ArrayList<UserMention>(other.userMentionList.size());
  ...
  public void addToHashtagList(HashTag elem) {
    if (this.hashtagList == null) {
      this.hashtagList = new java.util.ArrayList<HashTag>();
    }
    this.hashtagList.add(elem);
  }

  public java.util.List<HashTag> getHashtagList() {
    return this.hashtagList;
  }

  public TwitterEntities setHashtagList(java.util.List<HashTag> hashtagList) {
  ...
  public void addToUrlList(URL elem) {
    if (this.urlList == null) {
      this.urlList = new java.util.ArrayList<URL>();
    }
    this.urlList.add(elem);
  }

  public java.util.List<URL> getUrlList() {
    return this.urlList;
  }

  public TwitterEntities setUrlList(java.util.List<URL> urlList) {
  ...
  public void addToUserMentionList(UserMention elem) {
    if (this.userMentionList == null) {
      this.userMentionList = new java.util.ArrayList<UserMention>();
    }
    this.userMentionList.add(elem);
  }

  public java.util.List<UserMention> getUserMentionList() {
    return this.userMentionList;
  }

  public TwitterEntities setUserMentionList(java.util.List<UserMention> userMentionList) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case HASHTAG_LIST:
      if (value == null) {
        ...
        setHashtagList((java.util.List<HashTag>)value);
      }
      break;
    ...
    case URL_LIST:
      if (value == null) {
        ...
        setUrlList((java.util.List<URL>)value);
      }
      break;
    ...
    case USER_MENTION_LIST:
      if (value == null) {
        ...
        setUserMentionList((java.util.List<UserMention>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetHashtagList()) ? 131071 : 524287);
    if (isSetHashtagList())
      hashCode = hashCode * 8191 + hashtagList.hashCode();

    hashCode = hashCode * 8191 + ((isSetUrlList()) ? 131071 : 524287);
    if (isSetUrlList())
      hashCode = hashCode * 8191 + urlList.hashCode();

    hashCode = hashCode * 8191 + ((isSetUserMentionList()) ? 131071 : 524287);
    if (isSetUserMentionList())
      hashCode = hashCode * 8191 + userMentionList.hashCode();
  ...
  public int compareTo(TwitterEntities other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHashtagList()).compareTo(other.isSetHashtagList());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUrlList()).compareTo(other.isSetUrlList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUrlList()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUserMentionList()).compareTo(other.isSetUserMentionList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUserMentionList()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TwitterEntities(");
    boolean first = true;
  ...
  private static class TwitterEntitiesStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TwitterEntitiesStandardScheme getScheme() {
      return new TwitterEntitiesStandardScheme();
    }
  }

  private static class TwitterEntitiesStandardScheme extends org.apache.thrift.scheme.StandardScheme<TwitterEntities> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hashtagList = new java.util.ArrayList<HashTag>(_list8.size);
                HashTag _elem9;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.urlList = new java.util.ArrayList<URL>(_list11.size);
                URL _elem12;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.userMentionList = new java.util.ArrayList<UserMention>(_list14.size);
                UserMention _elem15;
  ...
  private static class TwitterEntitiesTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TwitterEntitiesTupleScheme getScheme() {
      return new TwitterEntitiesTupleScheme();
    }
  }

  private static class TwitterEntitiesTupleScheme extends org.apache.thrift.scheme.TupleScheme<TwitterEntities> {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.hashtagList = new java.util.ArrayList<HashTag>(_list23.size);
          HashTag _elem24;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.urlList = new java.util.ArrayList<URL>(_list26.size);
          URL _elem27;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.userMentionList = new java.util.ArrayList<UserMention>(_list29.size);
          UserMention _elem30;
