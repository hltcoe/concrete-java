...
public class Entity implements org.apache.thrift.TBase<Entity, Entity._Fields>, java.io.Serializable, Cloneable, Comparable<Entity> {
  ...
  private List<edu.jhu.hlt.concrete.TokenRefSequence> rawMentionList; // optional
  ...
  public Entity(Entity other) {
    ...
    if (other.isSetRawMentionList()) {
      List<edu.jhu.hlt.concrete.TokenRefSequence> __this__rawMentionList = new ArrayList<edu.jhu.hlt.concrete.TokenRefSequence>(other.rawMentionList.size());
  ...
  public void addToRawMentionList(edu.jhu.hlt.concrete.TokenRefSequence elem) {
    if (this.rawMentionList == null) {
      this.rawMentionList = new ArrayList<edu.jhu.hlt.concrete.TokenRefSequence>();
    }
   ...
   * mention of this Entity.
   */
  public List<edu.jhu.hlt.concrete.TokenRefSequence> getRawMentionList() {
   ...
   * mention of this Entity.
   */
  public Entity setRawMentionList(List<edu.jhu.hlt.concrete.TokenRefSequence> rawMentionList) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RAW_MENTION_LIST:
      if (value == null) {
        ...
        setRawMentionList((List<edu.jhu.hlt.concrete.TokenRefSequence>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_rawMentionList = true && (isSetRawMentionList());
    list.add(present_rawMentionList);
    if (present_rawMentionList)
      list.add(rawMentionList);
  ...
  public int compareTo(Entity other) {
    ...
    lastComparison = Boolean.valueOf(isSetRawMentionList()).compareTo(other.isSetRawMentionList());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rawMentionList = new ArrayList<edu.jhu.hlt.concrete.TokenRefSequence>(_list3.size);
  ...
  private static class EntityTupleScheme extends TupleScheme<Entity> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Entity struct) throws org.apache.thrift.TException {
      ...
      struct.setUuidIsSet(true);
      {
        ...
        struct.mentionIdList = new ArrayList<edu.jhu.hlt.concrete.UUID>(_list10.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.rawMentionList = new ArrayList<edu.jhu.hlt.concrete.TokenRefSequence>(_list13.size);
