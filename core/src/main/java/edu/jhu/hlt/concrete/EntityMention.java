            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.childMentionIdList = new ArrayList<edu.jhu.hlt.concrete.UUID>(_list32.size);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.childMentionIdList = new ArrayList<edu.jhu.hlt.concrete.UUID>(_list37.size);
