...
public class EntityMention implements org.apache.thrift.TBase<EntityMention, EntityMention._Fields>, java.io.Serializable, Cloneable, Comparable<EntityMention> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new EntityMentionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new EntityMentionTupleSchemeFactory();

  private edu.jhu.hlt.concrete.UUID uuid; // required
  private edu.jhu.hlt.concrete.TokenRefSequence tokens; // required
  private java.lang.String entityType; // optional
  private java.lang.String phraseType; // optional
  private double confidence; // optional
  private java.lang.String text; // optional
  private java.util.List<edu.jhu.hlt.concrete.UUID> childMentionIdList; // optional
  ...
  public EntityMention(EntityMention other) {
    ...
    if (other.isSetChildMentionIdList()) {
      java.util.List<edu.jhu.hlt.concrete.UUID> __this__childMentionIdList = new java.util.ArrayList<edu.jhu.hlt.concrete.UUID>(other.childMentionIdList.size());
   ...
   * The type of referent that is referred to by this mention.
   */
  public EntityMention setEntityType(java.lang.String entityType) {
   ...
   * The phrase type of the tokens that constitute this mention.
   */
  public EntityMention setPhraseType(java.lang.String phraseType) {
   ...
   * tokenization. This field may not be generated by all analytics.
   */
  public EntityMention setText(java.lang.String text) {
    this.text = text;
    return this;
  }
  ...
  public void addToChildMentionIdList(edu.jhu.hlt.concrete.UUID elem) {
    if (this.childMentionIdList == null) {
      this.childMentionIdList = new java.util.ArrayList<edu.jhu.hlt.concrete.UUID>();
    }
   ...
   * EntityMention.
   */
  public java.util.List<edu.jhu.hlt.concrete.UUID> getChildMentionIdList() {
   ...
   * EntityMention.
   */
  public EntityMention setChildMentionIdList(java.util.List<edu.jhu.hlt.concrete.UUID> childMentionIdList) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PHRASE_TYPE:
      if (value == null) {
        ...
        setPhraseType((java.lang.String)value);
      }
      break;
    ...
    case CHILD_MENTION_ID_LIST:
      if (value == null) {
        ...
        setChildMentionIdList((java.util.List<edu.jhu.hlt.concrete.UUID>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPhraseType()) ? 131071 : 524287);
    if (isSetPhraseType())
      hashCode = hashCode * 8191 + phraseType.hashCode();
    ...
    hashCode = hashCode * 8191 + ((isSetChildMentionIdList()) ? 131071 : 524287);
    if (isSetChildMentionIdList())
      hashCode = hashCode * 8191 + childMentionIdList.hashCode();
  ...
  public int compareTo(EntityMention other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPhraseType()).compareTo(other.isSetPhraseType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPhraseType()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetChildMentionIdList()).compareTo(other.isSetChildMentionIdList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChildMentionIdList()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("EntityMention(");
    boolean first = true;
  ...
  private static class EntityMentionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public EntityMentionStandardScheme getScheme() {
      return new EntityMentionStandardScheme();
    }
  }

  private static class EntityMentionStandardScheme extends org.apache.thrift.scheme.StandardScheme<EntityMention> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.childMentionIdList = new java.util.ArrayList<edu.jhu.hlt.concrete.UUID>(_list32.size);
                edu.jhu.hlt.concrete.UUID _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new edu.jhu.hlt.concrete.UUID();
                  _elem33.read(iprot);
                  struct.childMentionIdList.add(_elem33);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.childMentionIdList != null) {
        if (struct.isSetChildMentionIdList()) {
          oprot.writeFieldBegin(CHILD_MENTION_ID_LIST_FIELD_DESC);
          {
            ...
            for (edu.jhu.hlt.concrete.UUID _iter35 : struct.childMentionIdList)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class EntityMentionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public EntityMentionTupleScheme getScheme() {
      return new EntityMentionTupleScheme();
    }
  }

  private static class EntityMentionTupleScheme extends org.apache.thrift.scheme.TupleScheme<EntityMention> {
      ...
      if (struct.isSetChildMentionIdList()) {
        {
          ...
          for (edu.jhu.hlt.concrete.UUID _iter36 : struct.childMentionIdList)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.childMentionIdList = new java.util.ArrayList<edu.jhu.hlt.concrete.UUID>(_list37.size);
          edu.jhu.hlt.concrete.UUID _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new edu.jhu.hlt.concrete.UUID();
            _elem38.read(iprot);
            struct.childMentionIdList.add(_elem38);
          }
        }
        struct.setChildMentionIdListIsSet(true);
      }
