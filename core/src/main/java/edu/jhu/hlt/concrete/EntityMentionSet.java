...
public class EntityMentionSet implements org.apache.thrift.TBase<EntityMentionSet, EntityMentionSet._Fields>, java.io.Serializable, Cloneable, Comparable<EntityMentionSet> {
  ...
  static {
    schemes.put(StandardScheme.class, new EntityMentionSetStandardSchemeFactory());
    schemes.put(TupleScheme.class, new EntityMentionSetTupleSchemeFactory());
  }

  private edu.jhu.hlt.concrete.UUID uuid; // required
  private edu.jhu.hlt.concrete.AnnotationMetadata metadata; // required
  private List<EntityMention> mentionList; // required
  ...
  public EntityMentionSet(EntityMentionSet other) {
    ...
    if (other.isSetMentionList()) {
      List<EntityMention> __this__mentionList = new ArrayList<EntityMention>(other.mentionList.size());
  ...
  public void addToMentionList(EntityMention elem) {
    if (this.mentionList == null) {
      this.mentionList = new ArrayList<EntityMention>();
    }
   ...
   * List of mentions in this set.
   */
  public List<EntityMention> getMentionList() {
   ...
   * List of mentions in this set.
   */
  public EntityMentionSet setMentionList(List<EntityMention> mentionList) {
    this.mentionList = mentionList;
    return this;
  }
   ...
   * Entity linking annotations associated with this EntityMentionSet.
   */
  public EntityMentionSet setLinkingList(List<edu.jhu.hlt.concrete.Linking> linkingList) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MENTION_LIST:
      if (value == null) {
        ...
        setMentionList((List<EntityMention>)value);
      }
      break;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EntityMentionSet(");
    boolean first = true;
  ...
  private static class EntityMentionSetStandardSchemeFactory implements SchemeFactory {
    public EntityMentionSetStandardScheme getScheme() {
      return new EntityMentionSetStandardScheme();
    }
  }

  private static class EntityMentionSetStandardScheme extends StandardScheme<EntityMentionSet> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mentionList = new ArrayList<EntityMention>(_list32.size);
                EntityMention _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new EntityMention();
                  _elem33.read(iprot);
                  struct.mentionList.add(_elem33);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.linkingList = new ArrayList<edu.jhu.hlt.concrete.Linking>(_list35.size);
                edu.jhu.hlt.concrete.Linking _elem36;
                for (int _i37 = 0; _i37 < _list35.size; ++_i37)
                {
                  _elem36 = new edu.jhu.hlt.concrete.Linking();
                  _elem36.read(iprot);
                  struct.linkingList.add(_elem36);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EntityMentionSet struct) throws org.apache.thrift.TException {
      ...
      if (struct.mentionList != null) {
        oprot.writeFieldBegin(MENTION_LIST_FIELD_DESC);
        {
          ...
          for (EntityMention _iter38 : struct.mentionList)
          {
            _iter38.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.linkingList != null) {
        if (struct.isSetLinkingList()) {
          oprot.writeFieldBegin(LINKING_LIST_FIELD_DESC);
          {
            ...
            for (edu.jhu.hlt.concrete.Linking _iter39 : struct.linkingList)
            {
              _iter39.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class EntityMentionSetTupleSchemeFactory implements SchemeFactory {
    public EntityMentionSetTupleScheme getScheme() {
      return new EntityMentionSetTupleScheme();
    }
  }

  private static class EntityMentionSetTupleScheme extends TupleScheme<EntityMentionSet> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, EntityMentionSet struct) throws org.apache.thrift.TException {
      ...
      struct.metadata.write(oprot);
      {
        ...
        for (EntityMention _iter40 : struct.mentionList)
        {
          _iter40.write(oprot);
        }
      }
      ...
      if (struct.isSetLinkingList()) {
        {
          ...
          for (edu.jhu.hlt.concrete.Linking _iter41 : struct.linkingList)
          {
            _iter41.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, EntityMentionSet struct) throws org.apache.thrift.TException {
      ...
      struct.setMetadataIsSet(true);
      {
        ...
        struct.mentionList = new ArrayList<EntityMention>(_list42.size);
        EntityMention _elem43;
        for (int _i44 = 0; _i44 < _list42.size; ++_i44)
        {
          _elem43 = new EntityMention();
          _elem43.read(iprot);
          struct.mentionList.add(_elem43);
        }
      }
      struct.setMentionListIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.linkingList = new ArrayList<edu.jhu.hlt.concrete.Linking>(_list45.size);
          edu.jhu.hlt.concrete.Linking _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new edu.jhu.hlt.concrete.Linking();
            _elem46.read(iprot);
            struct.linkingList.add(_elem46);
          }
        }
        struct.setLinkingListIsSet(true);
      }
