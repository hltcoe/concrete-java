 ...
 *
 */
public class TarGzArchiveBoundedThriftIterator<T extends TBase<T, ? extends TFieldIdEnum>> implements AutoCloseableIterator<T> {
   ...
   */
  public TarGzArchiveBoundedThriftIterator(Class<T> clazz, InputStream is) throws IOException, ConcreteException {
